...
\author[Louisa Poggel, Caroline Baer]{Louisa Poggel, Caroline Baer}
...
$\blacktriangleright$ \textbf{Erreichen des 60.Lebensjahres:}\\
 \vspace{0.4cm}
\hspace{0.5cm} \textbf{1880:}~$\frac{1}{3}$ der Bevölkerung       \hspace{0.5cm} $\Longrightarrow$ \hspace{0.5cm} \textbf{1975:} $\frac{3}{4}$ der Bevölkerung\\
 \vspace{0.6cm}
...
\frametitle{Wichtige Datenquellen und Studien}
  \begin{block}{Sozio-oekonomische Panel (SOEP)}
   \begin{itemize}
     \item [$\blacktriangleright$] Deutsches Institut für   Wirtschaftsforschung (DIW)
...
\begin{frame}
\frametitle{Herausforderungen bei der Datenerhebung}
	\begin{itemize}
...
\vspace{0.2cm}
		\item[$\Rightarrow$] Netto-Äquivalenzeinkommen $=\frac{\text{Summe der Nettoeinkommen (in €)}}{\text{Summe der Personengewichte}}$
		\end{itemize}
\vspace{0.3cm}
...
\textbf{Überlebensraten nach Geschlecht und Einkommen}
	...
	{\small \emph{Quelle: SOEP, Periodensterbetafeln 1992-2016}}
\end{frame}

\begin{frame}
%\textbf{Mortalitätsrisiko vor einem Alter von 65 Jahren (in \%) }
	\includegraphics[scale=0.5]{Mortalitaet-Balkendiagramm-bearbeitet}
	{\small \emph{Quelle: SOEP, Periodensterbetafeln 1992-2016}}
\end{frame}
...
\begin{frame}
  \textbf{Allgemeine und gesunde Lebenserwartung nach Einkommen und Geschlecht}\\
	...
	{\small \emph{Quelle: SOEP, Periodensterbetafeln 1995-2005}}
\end{frame}
